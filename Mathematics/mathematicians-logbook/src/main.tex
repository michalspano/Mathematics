...
% TODO: this file is largely WIP. Update it to comply with the standards.
...
% Setup a counter for the exercises
\newcounter{exercise}
...
% FIXME: footnotes don't appear in equations, etc.
